        ...
        <div className="rf-entreprise-form-container">
          ...
          <form onSubmit={handleSubmit}>
            {[
              ...
              { label: "Type d'entreprise* (SARL, SAS, auto-entrepreneur)", name: 'prenom' },
              { label: "Numéro d'identification*  (SIREN/SIRET, NIF, etc.)", name: 'email' },
              { label: 'Adresse du siège social*', name: 'telephone' },
              { label: 'Adresse mail du représentant légal*', name: 'domaine' },
